...
def shuffle_alt(pregunta):
    """Módulo para randomizar las alternativas de una pregunta

    Args:
        pregunta (dict): diccionario propio de una pregunta, que contiene su enunciado y alternativas

    Returns:
        lista: lista de alternativas randomizadas de la pregunta
    """
